      ...
      <div className="py-12 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
        <div className="cursor-pointer flex items-center">
          ...
          <div className="text-2xl text-indigo-800 tracking-wide ml-2 font-semibold">
            <NavLink to={"/home"} style={{ color: "#6366F1" }}>
              AT
            </NavLink>
          </div>
        </div>
      </div>
      <div className="my-5 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-2 xl:px-24 xl:max-w-2xl">
        <h2
          ...
          <div>
            ...
            <div className="mt-2">
              ...
              <input
                ...
                onChange={formik.handleChange}
                className="w-full text-md py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500"
                placeholder="Nhập vào Mã Nhóm: GP01 - GP10"
              />
